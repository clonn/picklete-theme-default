      ...
      <div className="c-shop-cart-page-1">
        <div className="row c-cart-table-title">
          <div className="col-md-2 c-cart-image">
            <h3 className="c-font-uppercase c-font-bold c-font-16 c-font-grey-2">{lang('圖片')}</h3>
          </div>
          <div className="col-md-4 c-cart-desc">
            <h3 className="c-font-uppercase c-font-bold c-font-16 c-font-grey-2">{lang('簡述')}</h3>
          </div>
          <div className="col-md-2 c-cart-qty">
            <h3 className="c-font-uppercase c-font-bold c-font-16 c-font-grey-2">{lang('數量')}</h3>
          </div>
          <div className="col-md-1 c-cart-price">
            <h3 className="c-font-uppercase c-font-bold c-font-16 c-font-grey-2">{lang('單價')}</h3>
          </div>
          <div className="col-md-1 c-cart-total">
            <h3 className="c-font-uppercase c-font-bold c-font-16 c-font-grey-2">{lang('總價')}</h3>
          </div>
        ...
        {this.props.data.map((item, index) => (
          <div className="row c-cart-table-row" key={index}>
            ...
            <div className="col-md-2 col-sm-3 col-xs-6 c-cart-qty">
              <p className="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">{lang('數量')}</p>
            ...
            <div className="col-md-1 col-sm-2 col-xs-3 c-cart-price">
              <p className="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">{lang('單價')}</p>
              <p className="c-cart-price c-font-bold">${item.price}</p>
            </div>
            <div className="col-md-2 col-sm-2 col-xs-3 c-cart-total">
              <p className="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">{lang('總價')}</p>
            ...
            <div className="col-md-1 col-sm-12 c-cart-remove">
              ...
              <a onClick={this.props.dispatchRemoveCartItem.bind(null, index)} className="c-cart-remove-mobile btn c-btn c-btn-md c-btn-square c-btn-red c-font-uppercase" href="javascript:;">{lang('從購物車中移除')}</a>
            </div>
          </div>
        ))}
        <div className="row">
          <div className="c-cart-subtotal-row c-margin-t-20">
            <div className="col-md-2 col-md-offset-9 col-sm-6 col-xs-6 c-cart-subtotal-border">
              <h3 className="c-font-uppercase c-font-bold c-right c-font-16 c-font-grey-2">{lang('商品總價')}</h3>
            </div>
        ...
        <div className="row">
          <div className="c-cart-subtotal-row">
            <div className="col-md-2 col-md-offset-9 col-sm-6 col-xs-6 c-cart-subtotal-border">
              <h3 className="c-font-uppercase c-font-bold c-right c-font-16 c-font-grey-2">{lang('運費')}</h3>
            </div>
            <div className="col-md-1 col-sm-6 col-xs-6 c-cart-subtotal-border">
              <h3 className="c-font-bold c-font-16">{(shippingFee == 0)? lang('免運費') : `$${shippingFee}`}</h3>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="c-cart-subtotal-row">
            <div className="col-md-2 col-md-offset-9 col-sm-6 col-xs-6 c-cart-subtotal-border">
              <h3 className="c-font-uppercase c-font-bold c-right c-font-16 c-font-grey-2">{lang('結帳總價')}</h3>
            </div>
            <div className="col-md-1 col-sm-6 col-xs-6 c-cart-subtotal-border">
        ...
        <div className="c-cart-buttons">
          <Link to="/shop/department/1" className="btn c-btn btn-lg c-btn-red c-btn-square c-font-white c-font-bold c-font-uppercase c-cart-float-l">{lang('繼續購物')}</Link>
          <button onClick={this.props.goCheckout} className="btn c-btn btn-lg c-theme-btn c-btn-square c-font-white c-font-bold c-font-uppercase c-cart-float-r">{lang('結帳購買')}</button>
        </div>
      </div>
    )
  }
...
export default translate('Cart')(CartComponent)
