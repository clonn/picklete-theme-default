    ...
    return (
      <div className="c-shop-order-complete-1 c-content-bar-1 c-align-left c-bordered c-theme-border c-shadow">
        <div className="c-content-title-1">
          <h3 className="c-center c-font-uppercase c-font-bold">訂單結帳完成</h3>
          ...
          <div className="c-border-bottom hidden-sm hidden-xs">
            <div className="row">
              <div className="col-md-3">
                <h3 className="c-font-uppercase c-font-16 c-font-grey-2 c-font-bold">圖片</h3>
              </div>
              <div className="col-md-5">
                <h3 className="c-font-uppercase c-font-16 c-font-grey-2 c-font-bold">簡述</h3>
              </div>
              <div className="col-md-2">
                <h3 className="c-font-uppercase c-font-16 c-font-grey-2 c-font-bold">商品單價</h3>
              </div>
              <div className="col-md-2">
                <h3 className="c-font-uppercase c-font-16 c-font-grey-2 c-font-bold">品項總價</h3>
              </div>
            </div>
          </div>
              ...
              <div className="row">
                  ...
                  <div className="c-content-overlay">
                    <div className="c-overlay-wrapper">
                      <div className="c-overlay-content">
                        <Link to={`/shop/product/${item.id}`} className="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">查看商品</Link>
                      </div>
                    </div>
                ...
                <div className="col-md-5 col-sm-8">
                  <ul className="c-list list-unstyled">
                    ...
                    <li>購買數量: {item.quantity}</li>
                  </ul>
                </div>
                <div className="col-md-2 col-sm-2">
                  <p className="visible-xs-block c-theme-font c-font-uppercase c-font-bold">商品單價</p>
                  <p className="c-font-sbold c-font-uppercase c-font-18">${item.price}</p>
                </div>
                <div className="col-md-2 col-sm-2">
                  <p className="visible-xs-block c-theme-font c-font-uppercase c-font-bold">品項總價</p>
